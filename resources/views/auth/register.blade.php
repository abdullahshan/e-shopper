              ...
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Sign up</p>
                    ...
                    @enderror
                        <label class="form-label" name="name" for="form3Example1c">Your Name</label>
                      </div>
                    </div>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <input type="password" name="password_confirmation" id="form3Example4cd" class="form-control @error('password_confirmation') is-invalid @enderror" />
                    ...
                    <div class="form-check d-flex justify-content-center mb-5">
                      <label class="form-check-label" for="form2Example3">
                       Already have an account <a class="btn btn-primary" href="{{ route('login') }}">login</a>
                      </label>
                    </div>
