...
<html lang="en" class="light">
    ...
    <head>
        ...
        <!-- BEGIN: CSS Assets-->
        <link rel="stylesheet" href="http://127.0.0.1:8000/backend/dist/css/app.css"/>
...
<body class="main">
    ...
    <div class="d-flex">
        ...
        @include('layouts.backend.backendsidemenu')
            ...
            <div class="top-bar">
                            ...
                            <div class="mb-5">
                                <a href="index.html" class="d-flex align-items-center mt-2">
                                    <div class="w-8 h-8 image-fit">
                                        <img alt="Rubick Tailwind HTML Admin Template" class="rounded-circle" src="{{ asset('backen/') }}">
                                    </div>
                ...
                <div class="intro-x dropdown w-8 h-8">
                    <div class="dropdown-toggle w-8 h-8 rounded-pill overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false" data-bs-toggle="dropdown">
                        <img alt="Rubick Tailwind HTML Admin Template" src="https://api.dicebear.com/6.x/initials/svg?seed=k">
                    </div>
                        ...
                        <ul class="dropdown-content bg-theme-26 dark-bg-dark-6 text-white">
                            ...
                            <li>
                                ...
                                onclick="event.preventDefault();
                                 ...
                                 {{ __('Logout') }}
                             </a><i data-feather="toggle-right" class="w-4 h-4 me-2"></i></a>
 ...
 <script src="http://127.0.0.1:8000/backend/dist/js/app.js"></script>
 <!-- END: JS Assets-->
</body>
</html>